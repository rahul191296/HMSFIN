...
<center><springform:form modelAttribute="updatePatient" method="get" action="updatePatientDetails.htm" >
<table>
<tr>
<td><springform:label path="patientId">PatientID:</springform:label>
<td><springform:input path="patientId" readonly="true"/>
<td><springform:label path="firstName">FirstName:</springform:label>
<td><springform:input path="firstName"></springform:input>
</td>
</tr>

<tr>
<td><springform:label path="lastName">LastName:</springform:label>
<td><springform:input path="lastName"></springform:input>

<td><springform:label path="gender">Gender:</springform:label>
<td>
	<select name="gender" style="color:black; width:100%; padding:8px 20px;  background:rgba(255,255,255,0.8);" required>
...
<td><springform:input type="password" path="password" id="psw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 
...
<td><springform:input type="date"   style="color:black; width:78%; padding:8px 20px;" min ="1900-01-01" path="doB" id="dob" onchange="return agecalculator(this)"   onclick="return validate(this);" onkeypress="return false" ></springform:input>
<td><springform:label path="contactNumber">Contact_Number:</springform:label>
<td><springform:input type="number" path="contactNumber" id="cno" pattern ="[6-9]{1}[0-9]{9}" title="Contact Number must be 10 digits" ></springform:input>
...
<td><springform:input type="number" path="altContactNumber" id="acno" pattern ="[6-9]{1}[0-9]{9}"
...
<td><springform:input path="emailId" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"  style="color:black; width:75%;" ></springform:input>
</tr>
...
<td><springform:input path="city"></springform:input>
	t<td><springform:label path="state">State:</springform:label>
<td><springform:input path="state"></springform:input>
</tr>

<tr>
<td><springform:label path="zipCode">Zip_Code:</springform:label>
<td><springform:input type="number" path="zipCode"></springform:input>
