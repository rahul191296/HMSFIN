...
<center><springform:form modelAttribute="diagnosis" method="get" action="addDiagnosisDetails.htm" >
<table>

<tr>
<td><springform:label path="patientId">Patient_Id:</springform:label>
<td><springform:input path="patientId" value="${patientId}" readonly="true" ></springform:input>
<td><springform:label path = "physicianId">Physician_Id:</springform:label></td>
              
              <td><springform:select path="physicianId" style=" padding:8px 25px; width:100%; background:rgba(255,255,255, 0.6);">
							<springform:options  items="${physicianIdList}" style=" padding:8px 25px; width:100%;" />
						</springform:select>
</tr> 
<tr>
...
<td><springform:input path="testResultDate" required="required"  type="date" style="width:75%;"></springform:input>
...
<td><springform:input style="padding-top:40px; padding-bottom:40px;" path="physicianComments" required="required"></springform:input>
<td><springform:label path="otherInfo">Other_Info:</springform:label>
<td><springform:input style="padding-top:40px; padding-bottom:40px;"  path="otherInfo"></springform:input>

</tr>
<tr>
<td><button style="float:right;" type="submit" value="DONE">Submit</button><br></td>
</tr>
</table>
